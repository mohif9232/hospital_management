...
app.put("/api/v1/activate_me", auth("User"), activateme)
...
app.put("/api/v1/user/export_user", auth("viewPatint"), exporUsert)
...
app.get("/api/v1/user/export_doctor", auth("exportDr"), unActive)
